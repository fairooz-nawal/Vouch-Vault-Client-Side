    ...
    return (
        <div className='w-full mb-[100px]'>
            <div className="w-full md:w-3/4 lg:w-3/4 mx-auto p-5 space-y-4 text-center">
                ...
                <h1 className=' text-2xl md:text-3xl lg:text-5xl font-bold'>We Work With</h1>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:p-10 lg:p-10 lg:w-[94%] mx-auto">
                <Slide direction="left">
                    <div className="space-y-4 bg-lime-100 shadow-2xl border-2 border-gray-300  text-gray-800 hover:bg-red-500 hover:text-white hover:scale-110">
