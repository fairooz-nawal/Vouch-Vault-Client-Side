    ...
    return (
        <div className="my-[100px]">
            <div className="text-center">
                ...
                <h1 className=' text-2xl md:text-3xl lg:text-5xl font-bold'>Successful work</h1><br /><br />
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2'>
                <div className=""><img className="w-full h-full object-cover" src={bg} alt="" /></div>
                <div className="bg-lime-100">
                    <div className="space-y-4 md:ml-5 md:mt-5 text-black p-5">
                        <p className='text-orange-600 font-semibold text-2xl p-5 bg-white'>Ready to serve you</p>
                        <h1 className=' text-2xl md:text-3xl lg:text-5xl font-bold'>Successful work With successful team</h1>
