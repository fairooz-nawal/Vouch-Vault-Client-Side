    ...
    return (
        <div className="">
            <div className="text-center">
                ...
                <h1 className=' text-2xl md:text-3xl lg:text-5xl font-bold'>Successful work</h1>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2'>
                ...
                <div className="bg-sky-500">
                    <div className="space-y-4 md:ml-5 md:mt-5 text-white p-5">
                        ...
                        <h1 className=' text-2xl md:text-3xl lg:text-5xl font-bold'>Successful work With successful team</h1><br /><br />
